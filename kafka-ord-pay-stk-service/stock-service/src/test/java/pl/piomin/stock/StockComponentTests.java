...
public class StockComponentTests {
    ...
    void eventAccept() throws ExecutionException, InterruptedException, TimeoutException {
        ...
        SendResult<Long, Order> r = template.send("orders", o.id(), o)
        ...
        assertEquals("ACCEPT", rec.value().status());
